...
sub addHelp{
   ...
   $self->addHelpItem("[counter]", "Maintain counters. To create: counter -create=<name>. counter + <counter_name> to add.  counter - <counter_name> to subtract. Other flags: -set -delete -nick -all -lastupdate.  help counter <-flag> for flag help"); 
